...
const SubCategoryPage = ({ subcategory }) => {
  ...
  return (
    <>
      ...
      <Container className="subcategory-page-container">
      ...
      {selectedItem && (
        <Modal show={showModal} onHide={handleCloseModal} centered size="lg">
          <Modal.Header closeButton>
            <Modal.Title>{selectedItem.title} - Expense Details</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <table className="expense-table">
              ...
              <tbody>
                {selectedItem.expenses.breakdown.map((item, index) => (
                  <tr key={index}>
                    <td>{item.item}</td>
              ...
              <tfoot>
                <tr className="total-row">
                  <td>Total</td>
                  <td className="text-end">{selectedItem.expenses.total}</td>
                </tr>
              </tfoot>
            </table>
          </Modal.Body>.
